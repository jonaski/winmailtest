...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent),
  ...
  connect(ui_->button_test_mapi, SIGNAL(clicked()), SLOT(TestMAPI()));
...
void MainWindow::TestMAPI() {
  ...
  LPMAPISENDMAIL mapi_sendmail = (LPMAPISENDMAIL)GetProcAddress(mapi_lib, TEXT("MAPISendMail"));
  if (!mapi_sendmail) {
