...
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent) {
  ...
  setWindowTitle(tr("About Win Mail Tester"));

  ui_.label_icon->setPixmap(IconLoader::Load("internet-mail").pixmap(64));
  ...
  html += tr("Win Mail Tester is a simple program to test MAPI and Outlook functionality in Windows by %1.").arg("<a href=\"https://jkvinge.net/\">Jonas Kvinge</a>");
  html += "<br />";
  html += tr("The program is free software, released under GPL. The source code is available on GitHub %1").arg("<a href=\"https://github.com/jonaski/winmailtest\">here</a>");
  html += "<br />";
